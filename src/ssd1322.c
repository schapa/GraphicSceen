...
void SSD1322_InitDisplay(void) {
	...
	SendCmd_One(SSD1322_SET_CLOCK_DIVIDER, 0x01);
	...
	SendCmd_One(SSD1322_SET_PHASE_LENGTH, 0x56);
	SendCmd_One(SSD1322_SET_PHASE_LENGTH, 0x00);
	SendCmd_One(SSD1322_SET_PHASE_LENGTH, 0xFF);
	SendCmd_One(SSD1322_SET_PRECHARGE_VOLTAGE, 0x1F);
	SendCmd_One(SSD1322_SET_PRECHARGE_PERIOD_2, 0x0F);
